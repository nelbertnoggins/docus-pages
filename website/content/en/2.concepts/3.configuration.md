...
![og image documentation page](https://nelbertnoggins.github.io/docus-pages/__og-image__/static/en/concepts/configuration/og.png){.rounded-lg}
...
![og image landing page](https://nelbertnoggins.github.io/docus-pages/__og-image__/static/en/og.png){.rounded-lg}
